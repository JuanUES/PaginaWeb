...
//RUTAS TIPO CONTRATO
Route::resource('admin/tcontrato', 'App\Http\Controllers\Tipo_ContratoController')->except(['show'])->names('admin.tcontrato');
...
//RUTAS TIPO JORNADA
Route::resource('admin/tjornada', 'App\Http\Controllers\Tipo_JornadaController')->except(['show'])->names('admin.tjornada');
