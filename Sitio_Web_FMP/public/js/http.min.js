    ...
    $.ajax({
        ...
        error : function(jqXHR, textStatus){
            ...
            $(notificacion).removeClass();
                $(notificacion).show();                
                $(notificacion).addClass('alert alert-info bg-info text-white border-0');
