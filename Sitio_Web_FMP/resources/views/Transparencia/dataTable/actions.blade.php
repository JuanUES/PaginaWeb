<div class="text-center">
    <button type="button" data-key="{{ ($id) }}" data-toggle="modal" data-target="#modalView" class="btn btn-info btn-sm openModal"><i class="fa fa-file-pdf fa-fw" aria-hidden="true"></i></button>
