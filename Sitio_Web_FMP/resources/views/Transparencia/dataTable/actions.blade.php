<div class="text-center">
    <button type="button" data-id="{{ $id }}" data-toggle="modal" data-target="#modalViewPDF" class="btn btn-outline-info btn-sm btnViewPDF" title="Visualizar PDF"><i class="fa fa-file-pdf fa-fw" aria-hidden="true"></i></button>
