                        ...
                        <div class="tab-pane show active" id="agronomica" >
                            <div class="row">
                                <div class="col-xl-8 order-first ">
                                    ...
                                    <p class="text-muted font-13 text-justify">I70304 </p>
                                    ...
                                    <p class="text-muted font-13 text-justify">La estructura de la Carrera de Ingeniería Agronómica comprende tres ejes:</p>
                                    <ul>
                                        <li>
                                            <p class="text-muted font-13 text-justify">
