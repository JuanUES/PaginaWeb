    ...
    <div class="col-xl-4">
        ...
        <div class="card-box">
            ...
            <div class="mb-3 mt-4">
                <div class="float-right d-none d-xl-block">
                    <img src="{{ asset('template-admin/dist/assets/images/cards/visa.png') }}" alt="user-card"
                        height="28" />
                    <img src="{{ asset('template-admin/dist/assets/images/cards/master.png') }}" alt="user-card"
                        height="28" />
                    <img src="{{ asset('template-admin/dist/assets/images/cards/american-express.png') }}"
                        alt="user-card" height="28" />
                </div>
        ...
        <div class="card-box widget-chart-one gradient-success bx-shadow-lg">
            <div class="float-left" dir="ltr">
                <input data-plugin="knob" data-width="80" data-height="80" data-linecap=round data-fgColor="#ffffff"
                    data-bgcolor="rgba(255,255,255,0.2)" value="49" data-skin="tron" data-angleOffset="180"
...
<div class="row">
    <div class="col-xl-3">
        <div class="card-box">
            ...
            <div>
                <p><i class="mdi mdi-stop-circle-outline text-success"></i> Wallet Ballance <span
                        class="float-right font-weight-normal">$825.25</span></p>
                <p><i class="mdi mdi-stop-circle-outline text-danger"></i> Travels <span
                        class="float-right font-weight-normal">$1,254</span></p>
                <p class="mb-0"><i class="mdi mdi-stop-circle-outline"></i> Foods & Drinks <span
                        class="float-right font-weight-normal">$89.66</span></p>
            </div>
        </div> <!-- end card-box -->
    </div> <!-- end col -->
            ...
            <div class="table-responsive">
                <table class="table table-centered table-hover mb-0" id="datatable">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <img src="{{ asset('template-admin/dist/assets/images/users/avatar-2.jpg') }}"
                                    alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                <span class="ml-2">Imelda J. Stanberry</span>
                            </td>
                            <td>
                                <img src="{{ asset('template-admin/dist/assets/images/cards/visa.png') }}"
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('template-admin/dist/assets/images/users/avatar-3.jpg') }}"
                                    alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                <span class="ml-2">Francisca S. Lobb</span>
                            </td>
                            <td>
                                <img src="{{ asset('template-admin/dist/assets/images/cards/master.png') }}"
                                    alt="user-card" height="24" />
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('template-admin/dist/assets/images/users/avatar-1.jpg') }}"
                                    alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                <span class="ml-2">James A. Wert</span>
                            </td>
                            <td>
                                <img src="{{ asset('template-admin/dist/assets/images/cards/amazon.png') }}"
                                    alt="user-card" height="24" />
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('template-admin/dist/assets/images/users/avatar-4.jpg') }}"
                                    alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('template-admin/dist/assets/images/users/avatar-5.jpg') }}"
                                    alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                <span class="ml-2">Karen I. McCluskey</span>
                            </td>
                            <td>
                                <img src="{{ asset('template-admin/dist/assets/images/cards/discover.png') }}"
                                    alt="user-card" height="24" />
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('template-admin/dist/assets/images/users/avatar-6.jpg') }}"
                                    alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('template-admin/dist/assets/images/users/avatar-7.jpg') }}"
                                    alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('template-admin/dist/assets/images/users/avatar-8.jpg') }}"
                                    alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('template-admin/dist/assets/images/users/avatar-9.jpg') }}"
                                    alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('template-admin/dist/assets/images/users/avatar-10.jpg') }}"
                                    alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
    ...
    <div class="col-xl-3">
        ...
        <div class="card-box">
            <div class="media">
                <img class="mr-3 rounded-circle bx-shadow-lg"
                    src="{{ asset('template-admin/dist/assets/images/users/avatar-4.jpg') }}"
                    alt="Generic placeholder image" height="80">
                <div class="media-body">
                    <h5 class="mt-0">Louis P. Wheeler</h5>
                    Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras
                    purus odio, at, tempus viverra turpis.
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="progress-w-percent">
                        ...
                        <div class="progress progress-sm">
                            <div class="progress-bar bg-info" role="progressbar" style="width: 61%;" aria-valuenow="61"
                                aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
